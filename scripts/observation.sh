...
sudo python3 $SOURCE_FOLDER/main.py -n $MESSAGES -t json -i 11000 -a $MESSAGES 192.168.42.11 $DEST_IP 8080 $DEST_PORT &
sudo python3 $SOURCE_FOLDER/main.py -n $MESSAGES -t json -i 12000 -a $MESSAGES 192.168.42.11 $DEST_IP 8080 $DEST_PORT &
sudo python3 $SOURCE_FOLDER/main.py -n $MESSAGES -t json -i 13000 -a $MESSAGES 192.168.42.11 $DEST_IP 8080 $DEST_PORT &
sudo python3 $SOURCE_FOLDER/main.py -n $MESSAGES -t json -i 14000 -a $MESSAGES 192.168.42.11 $DEST_IP 8080 $DEST_PORT &
sudo python3 $SOURCE_FOLDER/main.py -n $MESSAGES -t json -i 15000 -a $MESSAGES 192.168.42.11 $DEST_IP 8080 $DEST_PORT &
sudo python3 $SOURCE_FOLDER/main.py -n $MESSAGES -t json -i 16000 -a $MESSAGES 192.168.42.11 $DEST_IP 8080 $DEST_PORT &
sudo python3 $SOURCE_FOLDER/main.py -n $MESSAGES -t json -i 17000 -a $MESSAGES 192.168.42.11 $DEST_IP 8080 $DEST_PORT &
